...
module.exports.run = async (bot, message, args) => {
    ...
    const authority_commands =
        ...
        `**|${botconfig.prefix}` + "tempmute [membro] [tempo] |**" + "`` - `` Muta temporariamente um membro do servidor.\n" +
        ...
        `**|${botconfig.prefix}` + "report [membro] [motivo] |**" + "`` - `` Denuncia um membro do servidor para os administradores.\n" +
